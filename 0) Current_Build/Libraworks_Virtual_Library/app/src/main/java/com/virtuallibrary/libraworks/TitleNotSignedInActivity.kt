...
//Class for the title screen while not signed in
class TitleNotSignedInActivity : AppCompatActivity() {
    // Connect to Firebase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_titlescreennotsignedin)
        readBookCover()
        ...
        val loginRegisterButton = findViewById<Button>(R.id.button4)
