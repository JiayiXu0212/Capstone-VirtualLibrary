...
class LoginActivitySpecial : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (auth.currentUser != null) {
            // Already signed in
            startActivity(Intent(this@LoginActivitySpecial, BarcodeActivity::class.java))
            finish()
        } else {
            ...
            startActivityForResult(
                AuthUI.getInstance()
                    ...
                    .setTheme(R.style.Theme_Libraworks_NoActionBar)
